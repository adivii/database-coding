...
int pinjam_buku(int id_buku){
	system("clear");
	string temp_pengguna;int id_pengguna;
	cout << "============================================================ \n";
	cout << "=================== Perpustakaan Bersama =================== \n";
	cout << "============================================================ \n";
	...
	if(data_buku[id_buku][3]=="Tersedia"){ //memastikan buku yang dipilih tersedia
...
int kembalikan_buku(){
	...
	for(int i=0;i<jumlah_pinjam[id_pengguna];i++){
		...
		cout << "next untuk menuju buku selanjutnya dalam daftar\n";
		cout << "back untuk kembali ke buku sebelumnya.\n";
		cout << "============================================================ \n";
		cout << "\n=> ";cin >> choose;
		...
		if(choose=="next"){
			if(i==jumlah_pinjam[id_pengguna]-1){
				i = -1;
			}
			else{
				continue;
			...
			data_buku[id_buku][3] = "Tersedia"; //mengubah status buku
			jumlah_pinjam[id_pengguna] -= 1;
